...
- (void)setLayoutWithModeSwitchButton:(BOOL)hasAModeSwitchButton {
    ...
    if (((AppDelegate *)[UIApplication sharedApplication].delegate).inNightMode) {
        ...
        [_editView setBorderWidth:1 andColor:[UIColor borderColor]];
    ...
    if (hasAModeSwitchButton) {
        ...
        [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-5-[_modeSwitchButton(22)]-5-[_editView]-8-[_inputViewButton(25)]" options:0 metrics:nil views:views]];
