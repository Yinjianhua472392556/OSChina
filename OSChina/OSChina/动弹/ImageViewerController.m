...
- (void)viewDidLoad {
    ...
    if (_image) {
        ...
        [_imageView sd_setImageWithURL:_imageURL placeholderImage:nil options:SDWebImageContinueInBackground | SDWebImageProgressiveDownload progress:^(NSInteger receivedSize, NSInteger expectedSize) {
            _HUD.progress = (CGFloat)receivedSize / expectedSize;
