...
- (instancetype)initWithXML:(ONOXMLElement *)xml {
    ...
    if (self = [super init]) {
        ...
        _url = [NSURL URLWithString:[[[xml firstChildWithTag:@"url"] stringValue] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]]];
        ...
        _eventURL = [NSURL URLWithString:[[[newsType firstChildWithTag:@"eventurl"] stringValue] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]]];
